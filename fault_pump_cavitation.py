...
def generate_all(upload_num: int, onset: int,
    ...
    # Pump cavitation failure threshold: dev >= 0.75 for the primary sensor (audio)
    dev_audio = sensor_deviation(upload_num, onset, lag=AUDIO_LAG, steepness=0.43)
    return dev_audio >= 0.75
