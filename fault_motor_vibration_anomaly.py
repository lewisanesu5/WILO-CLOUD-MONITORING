...
def generate_all(upload_num: int, onset: int,
    ...
    # Motor vibration anomaly failure threshold: accel dev >= 0.80 (severe structural resonance)
    _dev = sensor_deviation(upload_num, onset, lag=ACCEL_LAG, steepness=0.42)
    return _dev >= 0.80
